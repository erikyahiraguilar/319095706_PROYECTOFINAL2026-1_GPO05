...
//Variables animacion puerta
bool doorOpen = false;
float doorCurrentAngle = 0.0f;
float doorTargetAngle = 0.0f;
bool prevP = false;

// Animación puerta de cochera
bool garageOpen = false;
bool prevO = false;

// valores actuales (lo que se dibuja)
float garageCurrentRotX = 0.0f;
float garageCurrentY = 0.0f;
float garageCurrentZ = 0.0f;

// valores objetivo (a dónde queremos llegar)
float garageTargetRotX = 0.0f;
float garageTargetY = 0.0f;
float garageTargetZ = 0.0f;

// Variables animación puerta microondas
bool microOpen = false;
float microCurrentAngle = 0.0f;   // ángulo actual que se usa para dibujar
float microTargetAngle = 0.0f;   // ángulo objetivo (0° o 90°)
bool prevU = false;              // para detectar el flanco de la tecla U

// Rotación independiente de la taza
float mugAngle = 0.0f;           // ángulo acumulado de giro de la taza

// PAN TOSTADO (TOAST) 
bool  toastJumping = false;   // indica si está en animación
float toastTime = 0.0f;    // tiempo acumulado de la animación
float toastYOffset = 0.0f;    // desplazamiento en Y del salto
float toastRotX = 0.0f;    // rotación sobre eje X
bool  prevT = false;   // para detectar el flanco de la tecla T

const float toastJumpDuration = 1.0f;  // duración del salto (segundos)
const float toastJumpHeight = 0.6f;  // altura máxima del salto
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecto Final - 319095706", nullptr, nullptr);
	...
	Model PisoSala((char*)"Models/Objetos/pisoSala.obj");
	Model PisoCocina((char*)"Models/Objetos/pisoCocina.obj");
	...
	Model paredEntradaCocina((char*)"Models/Objetos/paredEntradaCocina.obj");
	Model marcopuertaAcocina((char*)"Models/Objetos/marcopuertaAcocina.obj");
	Model paredizqcocina((char*)"Models/Objetos/paredizqcocina.obj");
	Model paredatrascocina((char*)"Models/Objetos/paredatrascocina.obj");
	Model paredfrentecocina((char*)"Models/Objetos/paredfrentecocina.obj");
	...
	Model ventana11((char*)"Models/Objetos/ventana11.obj");
	Model ventana12((char*)"Models/Objetos/ventana12.obj");
	Model ventana13((char*)"Models/Objetos/ventana13.obj");
	Model ventana14((char*)"Models/Objetos/ventana14.obj");
	Model ventana15((char*)"Models/Objetos/ventana15.obj");
	Model ventana16((char*)"Models/Objetos/ventana16.obj");
	Model ventana17((char*)"Models/Objetos/ventana17.obj");
	Model casitaarribader((char*)"Models/Objetos/casitaarribader.obj");
	Model casitaarribaizq((char*)"Models/Objetos/casitaarribaizq.obj");
	Model casitaarribagrande((char*)"Models/Objetos/casitaarribagrande.obj");
	Model casitaizq((char*)"Models/Objetos/casitaizq.obj");
	Model techocasitaizq((char*)"Models/Objetos/techocasitaizq.obj");
	Model puertacasitaizq((char*)"Models/Objetos/puertacasitaizq.obj");
	Model cochera((char*)"Models/Objetos/cochera.obj");
	Model casitader((char*)"Models/Objetos/casitader.obj");
	Model techocasitader((char*)"Models/Objetos/techocasitader.obj");
	Model puertaAcocina((char*)"Models/Objetos/puertaAcocina.obj");
	Model escalera((char*)"Models/Objetos/escalera.obj");
	Model barandal((char*)"Models/Objetos/barandal.obj");
	Model mesalamp((char*)"Models/Objetos/mesalamp.obj");

	Model base((char*)"Models/lampara/base.obj");
	Model cabeza((char*)"Models/lampara/cabeza.obj");
	Model sillon1((char*)"Models/Objetos/sillon1.obj");
	Model sillon2((char*)"Models/Objetos/sillon2.obj");
	Model mesarectangular((char*)"Models/Objetos/mesarectangular.obj");
	Model tapete((char*)"Models/Objetos/tapete.obj");
	Model muebletv((char*)"Models/Objetos/muebletv.obj");
	Model tv((char*)"Models/Objetos/tv.obj");

	Model refri((char*)"Models/Objetos/refri.obj");
	Model cocinaintegralarriba1((char*)"Models/Objetos/cocinaintegralarriba1.obj");
	Model cocinaintegralarriba2((char*)"Models/Objetos/cocinaintegralarriba2.obj");
	Model cocinaintegralabajo1((char*)"Models/Objetos/cocinaintegralabajo1.obj");
	Model cocinaintegralabajo2((char*)"Models/Objetos/cocinaintegralabajo2.obj");
	Model cocinaintegralabajo3((char*)"Models/Objetos/cocinaintegralabajo3.obj");
	Model basearriba1((char*)"Models/Objetos/basearriba1.obj");
	Model basearriba2((char*)"Models/Objetos/basearriba2.obj");
	Model basearriba3((char*)"Models/Objetos/basearriba3.obj");
	Model stove((char*)"Models/Objetos/stove.obj");
	Model ventanainteriorcocina((char*)"Models/Objetos/ventanainteriorcocina.obj");
	Model microwave((char*)"Models/Objetos/microwave.obj");
	Model platomicrowave((char*)"Models/Objetos/platomicrowave.obj");
	Model puertamicro((char*)"Models/Objetos/puertamicro.obj");
	Model mug((char*)"Models/Objetos/mug.obj");
	Model tostadora((char*)"Models/Objetos/tostadora.obj");
	Model toast((char*)"Models/Objetos/toast.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "dirLight.ambient"), 0.20f, 0.20f, 0.20f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "dirLight.diffuse"), 0.30f, 0.30f, 0.30f);
		...
		// Point light 1
		// escala la luz
		glm::vec3 scaled = lightColor * 0.8f;
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		mesarectangular.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		PisoSala.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		PisoCocina.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		Pisoizq.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		Pisoder.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredSalaIzq.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredSalaDer.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredSalaEsc.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		pareddetrasesc.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredfrontal.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredfrentelineas.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredtraseracasa.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredfachadaizquierda.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana6.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana7.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana8.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana9.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		puertafueraizq.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		triangulo1.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		triangulo2.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana10.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana11.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana12.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana13.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana14.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana15.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana16.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventana17.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		casitaarribader.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		casitaarribaizq.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		casitaarribagrande.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		casitaizq.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		techocasitaizq.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		puertacasitaizq.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		casitader.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		techocasitader.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredEntradaCocina.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		marcopuertaAcocina.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredizqcocina.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredatrascocina.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		paredfrentecocina.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		cocinaintegralarriba1.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		cocinaintegralarriba2.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		cocinaintegralabajo1.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		cocinaintegralabajo2.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		cocinaintegralabajo3.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		basearriba1.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		basearriba2.Draw(lightingShader);

		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		basearriba3.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		ventanainteriorcocina.Draw(lightingShader);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		platomicrowave.Draw(lightingShader);
